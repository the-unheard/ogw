<?php foreach($fishingBadgetown as $badge) {

?>

    <div class="col-xl-4 col-lg-6 col-12 p-1">

        <h6 class="py-2 og-bg-gray-200 w-75 mx-auto" style="color: var(--offblackfont);"><?= $badge[0] ?> Bait</h6>
        <div class="fh-catches">
            <?php while($row = mysqli_fetch_assoc($badge[1])) {
