<?php foreach($fishingPortforward as $port) {

?>

    <div class="col-xl-4 col-lg-6 col-12 p-1">

        <h6 class="py-2 og-bg-gray-200 w-75 mx-auto" style="color: var(--offblackfont);"><?= $port[0] ?> Bait</h6>
        <div class="fh-catches">
            <?php while($row = mysqli_fetch_assoc($port[1])) {
